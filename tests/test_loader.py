...
def test_load_struct():
    ...
    ab_thrift_spec = {k: map(str, v) for k, v in ab.PhoneNumber.thrift_spec.iteritems()}
    ab_tt_thrift_spec = {k: map(str, v) for k, v in ab_tt.PhoneNumber.thrift_spec.iteritems()}
